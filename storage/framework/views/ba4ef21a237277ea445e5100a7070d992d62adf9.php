    ...
    <section class="section section-auth section-auth-login">
      <div class="display-spacing">
        <div class="container">
          ...
          <form class="form form-1" method="POST" action="<?php echo route('create-mitra'); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
              ...
              <div class="col-12">
                <div class="form-item">
                  ...
                  <input
                    type="text"
                    name="nik"
                    class="input-icon <?php if ($errors->has('nik')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" style="cursor: pointer;border: none" name="ktp">
                  </div>
                </div>
...
if (isset($messageCache)) { $message = $messageCache; }
              ...
              <div class="col-12">
                <div class="form-item">
                  <input type="submit" class="button button-lg button-block button-primary" value="<?php echo e(__('Upgrade')); ?>">
                </div>
              </div>
            </div>
          </form>
      ...
      <div class="pos-fixed">
        <div class="option">
          ...
          <div class="btn-option">
            <a class="button button-primary rounded" href="<?php echo e(url()->previous()); ?>" style="padding: 0 20px"><span>OK</span></a>
          </div>
        </div>
      </div>
    <?php endif; ?>
