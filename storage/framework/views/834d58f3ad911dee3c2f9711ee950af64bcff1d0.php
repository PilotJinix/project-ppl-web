                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                            <ul class="el-breadcrumbs el-breadcrumbs-1 text-light">
                                ...
                                <li>
                                    <a href="<?php echo e(url('about')); ?>" class="active">
                    ...
                    <div class="col-lg-6">
                        <div class="display-spacing custom-table">
                            ...
                            <div class="el-content">
                                ...
                                <a href="<?php echo e(route('dashboard')); ?>" class="button button-md button-primary" target="_blank">
                                    <span class="text">Halaman Baru</span>
                                </a>
                                <a href="<?php echo e(url('about')); ?>" class="button button-md button-line-primary" target="_blank">
                                    <span class="text">Tentang Kami</span>
                                </a>
                            </div>
                        </div>
