              ...
              <div class="row row-sm">
                <div class="col-lg-8">
                  ...
                  <div class="row row-sm">
                    <div class="col-md-12">
                      <div class="form-item">
                        <input type="text" class="<?php if ($errors->has('nama_lengkap')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('nama_lengkap'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="nama_lengkap" value="<?php echo e(__($akun->nama_lengkap)); ?>"/>
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-md-6">
                      <div class="form-item">
                        <input type="text" class="<?php if ($errors->has('email')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('email'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" value="<?php echo e(__($akun->email)); ?>"/>
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-md-6">
                      <div class="form-item">
                        <input type="text" class="<?php if ($errors->has('no_hp')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('no_hp'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="no_hp" value="<?php echo e(__($akun->nomer_hp)); ?>"/>
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-md-12">
                      <div class="form-item">
                        <input type="text" class="<?php if ($errors->has('alamat')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('alamat'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="alamat" value="<?php echo e(__($akun->alamat)); ?>"/>
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-12">
                      <div class="form-item">
                        <input type="text" class="<?php if ($errors->has('label_alamat')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('label_alamat'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="label_alamat" />
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-md-6">
                      <div class="form-item">
                        <input type="text" name="kode_pos" class="<?php if ($errors->has('kode_pos')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-md-6">
                      <div class="form-item">
                        <input type="text" name="kota" class="<?php if ($errors->has('kota')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-12">
                      <div class="form-item">
                        <textarea type="text" name="catatan_pembelian" class="<?php if ($errors->has('catatan_pembelian')) :
if (isset($message)) { $messageCache = $message; }
                        ...
                        <ul class="pl-0">
                          <li class="p-3" style="border: 1px solid #e3e3e3; border-radius: 5px">
                            <div class="row row-0 d-flex align-items-center">
                              <img src="<?php echo e(asset('assets/images/products/'.$detail->gambar)); ?>" alt="" width="70px">
                              <div class="pl-2 pt-1" style="width: 73%">
                                <label class="var" ><?php echo e(__($detail->nama)); ?></label>
                                <div class="d-flex align-items-center">
                                  <span>Rp</span>
                                  <input type="text" class="val text-right <?php if ($errors->has('harga')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('harga'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" value="<?php echo e(__($detail->harga)); ?>" readonly id="harga" style="width: 40px;">
                                </div>
                              </div>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="jumlah" type="number" value="1" min="1" max="10" step="1" name="jumlah">
                      ...
                      <li>
                        <div class="row row-sm">
                          ...
                          <div class="col-6 d-flex justify-content-end">
                            <span class="text-right">Rp <input id="biaya_pengiriman" type="text" name="biaya_pengiriman" class="<?php if ($errors->has('biaya_pengiriman')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('biaya_pengiriman'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?> val text-bold text-right text-dark" value="5000" readonly style="width: 50px"></span>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="row row-sm">
                          ...
                          <div class="col-6 d-flex justify-content-end">
                            <span class="text-right"><input id="diskon" type="text" name="diskon" class="val text-bold text-right text-dark <?php if ($errors->has('diskon')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('diskon'); ?> is invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" value="5" readonly style="width: 50px"> %</span>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="row row-sm">
                          ...
                          <div class="col-6 d-flex justify-content-end">
                            <input readonly id="bank" type="text" name="metode_pembayaran" class="text-right <?php if ($errors->has('jenis_bank')) :
if (isset($message)) { $messageCache = $message; }
      ...
      <div class="pos-fixed">
        <div class="option">
          ...
          <div class="btn-option pr-3">
            <a class="button button-primary rounded" href="<?php echo e(route('login')); ?>" style="padding: 0 20px"><span>Login</span></a>
            <a class="button button-secondary rounded" href="<?php echo e(url()->previous()); ?>" style="padding: 0 20px"><span>Kembali</span></a>
          </div>
        </div>
      </div>
    <?php endif; ?>
