        ...
        <div class="container">
          <div class="row row-0 ">
            <div class="border rounded p-4 w-75 m-auto shadow">
              <div class="row row-0">
                <div class="col-2">
                  <img src="<?php echo e(asset('assets/images/products/'.$item->gambar)); ?>" alt="gambar" width="100px">
                </div>
                <div class="col-6">
                  <h5 class="text-bold"><?php echo e(__($item->nama)); ?></h5>
                  <span class="p">Total: <label style="color: #cf6324">Rp<?php echo e(__($item->total_harga)); ?></label></span>
                  ...
                  <div class=" rounded pl-3 p-1 mb-2" style="background-color: #aaaaaa">
                    <span>
                      ...
                      <label class="mb-0 text-dark"><?php echo e(__('Bayar sebelum '.$item->batas_pembayaran.' WIB')); ?></label>
                    </span>
                  </div>
                  <div class="w-100">
...
</html><?php /**PATH /home/witsudi/LaravelProject/project-ppl/resources/views/status-pembelian.blade.php ENDPATH**/ ?>