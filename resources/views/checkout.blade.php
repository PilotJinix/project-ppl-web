                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-item">
                                            <label>Alamat*</label>
                                            <input type="text" class="mt-2 @error('alamat') is invalid @enderror"
                                                name="alamat" value="{{__($akun->alamat)}}" />
                                        </div>
                                        @error('alamat')
                                        <span class="text-danger invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-item">
                                            ...
                                            <input type="text" name="kota"
                                                class="mt-2 @error('kota') is invalid @enderror" />
                                        </div>
                                        @error('kota')
                                        <span class="text-danger invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12">
                                        <div class="form-item">
                                            ...
                                            <textarea type="text" name="catatan_pembelian"
                                                class="mt-2 @error('catatan_pembelian') is invalid @enderror"></textarea>
                                        </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="add-to-cart">
                                                        <div class="el-counter el-counter-1 d-block empty">
                                                            ...
                                                            <input class="@error('jumlah') is invalid @enderror"
                                                                id="jumlah" type="number" value="1" min="1"
                                                                max="{{__($detail->stok)}}" step="1" name="jumlah">
