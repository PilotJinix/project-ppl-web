            ...
            <div class="card mb-2">
                <div class="body d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        <img src="{{asset('assets/images/blog/'.$item->gambar)}}" alt="--img--" width="100px">
                        <div class="ml-3">
                            <h5>{!!$item->judul!!}</h5>
                            <p class="mb-0">Dipublikasikan : {!!$item->created_at!!}</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mr-5">
                        <a href="{{route('admin.edit-artikel',$item->id)}}">
                            <button class="btn tblActnBtn" title="edit" data-toggle="tooltip">
                                <i class="material-icons">mode_edit</i>
                            </button>
                        </a>
                        <a href="{{route('blog-detail',$item->id)}}" target="blank">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{route('admin.delete-artikel',$item->id)}}">
