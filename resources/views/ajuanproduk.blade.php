      ...
      <div class="container">
        <div class="row row-0">
          <div class="card w-100 shadow">
            ...
            <div class="card-body">
              <button id="buttonPatokanHarga" class="btn btn-secondary w-100">List Patokan Harga</button>
              <form method="post" class="mt-2">
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control-file border p-2 rounded" id="exampleFormControlFile1">
                </div>
                <div class="form-group">
            ...
            <div class="d-block">
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <button id="filter-button" class="input-group-text"><i class="fa fa-arrow-circle-down" aria-hidden="true"></i></button>
                </div>
              </div>
              <div id="filter-list" class="border rounded p-1 position-absolute bg-light mt-1" style="min-width: 15rem;display: none">
