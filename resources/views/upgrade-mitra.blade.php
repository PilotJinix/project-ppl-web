    ...
    <section class="section section-auth section-auth-login">
      <div class="display-spacing">
        <div class="container">
          ...
          <form class="form form-1" method="POST" action="{!! route('create-mitra') !!}" enctype="multipart/form-data">
            @csrf
            <div class="row row-sm">
              ...
              <div class="col-12">
                <div class="form-item">
                  ...
                  <input
                    type="email"
                    class="input-icon @error('email') is invalid! @enderror" 
              ...
              <div class="col-12">
                <div class="form-item">
                  ...
                  <input
                    type="text"
                    name="nik"
                    class="input-icon @error('nik') is invalid @enderror"
                    placeholder="NIK"
                  />
                  <div class="icon">
                    <i class="fa fa-address-card" aria-hidden="true"></i>
              ...
              <div class="col-12">
                <div class="form-item">
                  ...
                  <div class="rounded" style="border: 1px solid #e1e1e1;padding: 13px;border-radius: 5px">
                    <input type="file" class="@error('ktp') is fail @enderror" style="cursor: pointer;border: none" name="ktp">
                  </div>
                </div>
                @error('ktp')
                  <span class="text-danger invalid-feedback" role="alert">
              ...
              <div class="col-12">
                <div class="form-item">
                  <input type="submit" class="button button-lg button-block button-primary" value="{{__('Upgrade')}}">
                </div>
              </div>
            </div>
          </form>
